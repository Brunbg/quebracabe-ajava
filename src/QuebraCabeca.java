...
public class QuebraCabeca extends JPanel {
	...
	public QuebraCabeca (int dimensao, String[] nomes) {
	...
	public void iniciar() {
		...
		this.labelResultado.setSize(300, 30);
		this.labelResultado.setLocation(XINICIAL,YINICIAL+DIMENSAO*TAMANHO+40);
		this.labelResultado.setText("Selecione duas celulas para trocar de posicao");
...
//4ºMÉTODO: altera aleatoriamente a sequência dos números da matriz;
	...
	private void desenharGridOrdenado() {
		...
		for(int linha=0; linha < this.DIMENSAO; linha++){
			for(int coluna=0; coluna < this.DIMENSAO; coluna++){
				...
				ImageIcon icon =new ImageIcon(QuebraCabeca.class.getResource("/imagens3x3/" + (cont+1) + ".jpg"));
	...
	private void desenharGridDesordenado() {
		...
		for(int linha=0; linha < this.DIMENSAO; linha++){
			for(int coluna=0; coluna < this.DIMENSAO; coluna++){
				...
				ImageIcon icon =new ImageIcon(QuebraCabeca.class.getResource("/imagens3x3/" + (numero) + ".jpg"));
			//	ImageIcon icon =new ImageIcon(QuebraCabeca.class.getResource(nomesdearquivo[numero-1]));
						...
						new  MouseAdapter(){
							...
							public void mouseClicked(MouseEvent e){		//click no label 
								...
								if(QuebraCabeca.this.finalizado()) {
									QuebraCabeca.this.labelResultado.setText("FINALIZADO! - Reinicie");
...
//5ºMÉ - verifica se os números da matriz estão na sequência 1,2,3,...,NxN;
...
//6º MÉT: troca dois números da matriz e duas células do grid2 nas duas posições informadas.
